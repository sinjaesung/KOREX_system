...
import NewRequest from '../../../component/member/mypage/request/NewRequest';
...
//login_user info 로그인정보의 phone이랑 name이 비어있다면 addmODALUSER에서 tempBrokerqruest에 name,phone채워질것이고, 존재한다면 여기서 채운다.
...
export default function Join() {
  ...
  if (login_user.user_name != '' && login_user.phone != '') {
    tempBrokerRequestActions.namechange({ names: login_user.user_name });
    tempBrokerRequestActions.phonechange({ phones: login_user.phone });
  }
  return (
