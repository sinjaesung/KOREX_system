...
export default function JoinInput({pwd,pwdShow,setPwdShow,setPwd,pwdConfirm,setPwdConfirm,setActive}) {
    ...
    useEffect( () => {
      console.log('agency joinpwd 내부요소 변화 발생:',pwd,pwdConfirm);
    ...
    return (
        <Container>
          <InputTop>
            ...
            <MUTextField label="비밀번호" variant="outlined" type="password" name="" placeholder="비밀번호를 입력해주세요." maxlength="2" onChange={pwdChange} />
            ...
            <InputRow style={{"margin-bottom":0}}>
              ...
              <MUTextField label="비밀번호 확인" variant="outlined" type="password" name="" placeholder='비밀번호를 한번 더 입력해주세요.' maxlength="2" onChange={pwdConfirmChange}/>
            </InputRow>
          {/*비밀번호가 일치하지 않을때 show*/}
