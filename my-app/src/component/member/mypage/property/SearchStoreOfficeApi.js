...
export default function SearchStoreOfficeApi({setSearch_address,setAddressApi}) {
  ...
  const handleComplete = (data) => {
    ...
    */
    ...
    console.log('확인가능 : ', data);
    console.log('확인가능 : ', data.jibunAddress);
    let sido=data.sido;
    ...
    // setSearch_address({fulladdress_val:fullAddress, sido_val:data.sido, sigungu_val:data.sigungu,jibunaddress_val:jibunaddress, roadaddress_val:roadaddress});
    setSearch_address({ sgg_code: data.sigunguCode, dong_code: data.bcode, road_code: data.roadnameCode, addr_jibun: jibunaddress, addr_road: roadaddress});
    setAddressApi(false);
  }
