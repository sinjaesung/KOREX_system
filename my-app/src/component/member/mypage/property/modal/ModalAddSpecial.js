...
//필터 모달
export default function AddSpecial({speIsTimeRef, speTimeRef, speDateRef,speExcRef}) {
        ...
        <Container>
          ...
          {/*일자선택*/}
              <AddBox>
                ...
                <IputDate ref={speDateRef} type="date" placeholder="일자 선택" />
              </AddBox>
              <AddBox>
                <Label>시간</Label>
                <SwitchButton>
                ...
                <WrapSwit ref={speTimeRef}>
                  <LineBox>
                      ...
                      <InputCheck type="checkbox" className='specifydate_times'name="" id="time1" value='오전1T'/>
                    ...
                    <LineBox>
                      ...
                      <InputCheck type="checkbox" className='specifydate_times' name="" id="time2" value='오후1T'/>
                    ...
                    <LineBox>
                      ...
                      <InputCheck type="checkbox" className='specifydate_times' name="" id="time3" value='오후2T'/>
