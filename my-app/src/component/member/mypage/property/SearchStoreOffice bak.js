    ...
    <>
      <div className="par-spacing">
        ...
        <div className="clearfix">
          ...
          <ButtonAddrSearch variant="contained" disableElevation onClick={handleClick_AddrApi}>주소 검색</ButtonAddrSearch>
        </div>
        {
          addressApi ?
            <>
              ...
              >
                ...
                <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose_AddrApi}>주소 검색</BootstrapDialogTitle>
