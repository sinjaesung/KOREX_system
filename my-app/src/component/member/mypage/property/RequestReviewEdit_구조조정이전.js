...
export default function RequsetReview({acceptModal,cancleModal,setAccept,setCancle,disabled,brokerRequest_product,nowprdstatus}) {
  ...
  console.log('물건수정 기본정보 수정 페이지 state정보전달 확인:',brokerRequest_product,nowprdstatus);
            ...
            {/*기본정보 내용*/}
                ...
                <RequestAccept>
                   ...
                   <NextBtn type="button" onClick={()=> {
                     console.log('다음버튼 클릭 입력저보들 물건정보들:',brokerRequest_product);
                   }}>다음</NextBtn>
                </RequestAccept>
              </ReviewMiddle>
            </WrapReview>
