    ...
    <>
      <Wrapper>
        ...
        <Sect_R2>
          ...
          <div className="par-spacing">
            <MUTextField_100 variant="standard" label="상호명" type="text" placeholder="상호명을 입력해주세요." onChange={companyNameChange} value={companyname} />
          </div>
          <br />
          ...
          <div className="par-spacing">
            <MUTextField_100 disabled type="text" placeholder="도로명 주소" value={addr_road} variant="standard" />
          </div>
          ...
          <div className="par-spacing">
            <MUTextField_100 variant="standard" disabled type="text" placeholder="지번 주소" value={addr_jibun} />
          </div>
          <div className="par-spacing">
            <MUTextField_100 variant="standard" defaultValue="Hello world" label="상세주소" type="text" value={addressdetail} />
          </div>
          <br />
          ...
          <div className="par-spacing">
            <MUTextField_100 variant="standard" label="전화번호" type="text" helperText="전화번호를 ’-‘를 빼고 입력하여주세요" onChange={phoneChange} value={phone} />
          </div>

          {/* <InputTitle>대표명</InputTitle>
                <InputBox type="text" name="" placeholder="이름을 입력하여주세요." onChange={ceoNameChange} value={ceoname}/> */}
          <div className="par-spacing">
            <MUTextField_100 variant="standard" label="대표명" type="text" placeholder="이름을 입력하여주세요." onChange={ceoNameChange} value={ceoname} />
          </div>
          ...
          <div className="par-spacing">
            <MUTextField_100 variant="standard" label="대표 휴대폰 번호" type="text" placeholder="휴대번호를 ’-‘를 빼고 입력하여주세요." helperText="휴대번호를 ’-‘를 빼고 입력하여주세요" onChange={ceoPhoneChange} value={ceophone} />
          </div>
      ...
      <Modal_ProfileImgEdit open={openModalProfileImgEdit} handleOpen={hdOpenModalProfileImgEdit} setProfileImg={CompanyImgChange}/>
    </>
  );
}
