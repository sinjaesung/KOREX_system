...
//지도 모달
export default function ModalMapReserve({ probrokersingleinfo,map, setMap }) {
  if(map == false)
    return null;
    return (
        <Container>
          <WrapModalMap>
            ...
            <ModalMap>
              ...
              <ModalMapAddress>
                <AddressTxt>{probrokersingleinfo.addr_jibun}</AddressTxt>
                <ChangeAddress>
              ...
              <ShowMap>
                <KakaoMapSide cutomImg={Marker} centerLat={probrokersingleinfo.y} centerLng={probrokersingleinfo.x} markerLat={probrokersingleinfo.y} markerLng={probrokersingleinfo.x}/>
              </ShowMap>
            </ModalMap>
          </WrapModalMap>
        </Container>
