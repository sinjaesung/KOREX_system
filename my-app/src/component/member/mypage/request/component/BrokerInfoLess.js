...
export default function SideBarBrokerDetailContent({historyInfo,updatePageIndex,setHistoryInfo, setMap,probrokersingleinfo}) {
    return (
        <Container>
          <TopContent>
            <ProfileDetail>
                <BottomBox>
                  <LeftContent>
                    <ItemInfo>
                      <ComName>{probrokersingleinfo&& probrokersingleinfo.company_name}</ComName>
                      <Name>{probrokersingleinfo&& probrokersingleinfo.ceo_name}</Name>
                    </ItemInfo>
                  </LeftContent>
                  <RightContent>
                    <ItemImg src={Profile}/>
