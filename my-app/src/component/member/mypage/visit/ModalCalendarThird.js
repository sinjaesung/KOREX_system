...
export default function ModalCal({cal, confimReservation,setModalOption ,finalModal,offModal, updatePageIndex ,userList, setUserList }){
...
return (
  <Container>
        <Wraplive>
          <ModalClose>
            <Link onClick={() => {  updatePageIndex(0); }} >
