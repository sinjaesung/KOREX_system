                ...
                <Sect_R2>
...

                    {
                        addressApi ?
                            ...
                            //     </DialogContent>
                            // </Dialog>
                            <Modal_AddressApi title="주소 검색" open={addressApi} handleOpen={setAddressApi} handleCheck={setApartCheckOption}>
                                <MapApi setapart_addr_road={setapart_addr_road} setaptname={setaptname} setAddressApi={setAddressApi} />
                            </Modal_AddressApi>
                    ...
                    }
                    {
                        addressApi2 ?
                            ...
                            // >
                            //     <BootstrapDialogTitle id="customized-dialog-title" onClose={() => { setAddressApi2(false); setOfficetelsCheckOption(false); setisofficetel(0); }}>
                            //         주소 검색
                            //     </BootstrapDialogTitle>
                            //     <DialogContent className="muDlogCont-postApi">
                            //         <Typography>
                            ...
                            //     </DialogContent>
                            // </Dialog>
                            <Modal_AddressApi title="주소 검색" open={addressApi2} handleOpen={setAddressApi2} handleCheck={setOfficetelsCheckOption}>
                                <MapApi2 setofficetel_addr_road={setofficetel_addr_road} setofficetelname={setofficetelname} setAddressApi2={setAddressApi2} />
                            </Modal_AddressApi>
                            // <AddressApi>
