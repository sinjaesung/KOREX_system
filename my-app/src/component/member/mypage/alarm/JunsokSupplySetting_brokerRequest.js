  ...
  return (
    <>
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="내 중개의뢰"
          control={<Checkbox checked={alramsetting['notiset_brokerprd'] == 1 ? true : false} onChange={notiset_brokerprd_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
          알림수신: 상태 변경시
        </p>
      ...
      <MUListItem disablePadding>
        <MUListItemButton onClick={() => { setOpen(true) }}>
          <MUListItemText>
            ...
            <span className="vAlign-b mr-1 muCheckbox-label">내 중개의뢰별 설정</span>
      ...
      {
        open ?
          <ModalAlarm open={open} setOpen={setOpen} brokerproductlist={brokerRequest_productlist} />
          :
          null
      }
    </>
