...
export default function ItemTabList({ value, alramsetting, setalramsetting }) {
  ...
  console.log('bunyangSupplySettingsss:',bunyangTeam);
  ...
  return (
    <>
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="Live시청예약접수 관리"
          control={<Checkbox checked={alramsetting['notiset_bunyangsupply_live_reserv'] == 1 ? true : false} onChange={notiset_bunyangsupply_live_reserv_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
          알림수신: 예약 접수시
        </p>
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="방문예약접수 관리"
          control={<Checkbox checked={alramsetting['notiset_bunyangsupply_visit_reserv'] == 1 ? true : false} onChange={notiset_bunyangsupply_visit_reserv_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
          알림수신: 예약 접수시
        </p>
