  ...
  return (
    <>
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="분양 중개건"
          control={<Checkbox checked={alramsetting['notiset_bunyangsuyo_project'] == 1 ? true : false} onChange={notiset_bunyangsuyo_project_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
          알림수신: 신규 분양프로젝트 등록시
        </p>
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="분양Live방송 예고"
          control={<Checkbox checked={alramsetting['notiset_bunyangsuyo_newlive'] == 1 ? true : false} onChange={notiset_bunyangsuyo_newlive_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="내 Live시청 예약"
          control={<Checkbox checked={alramsetting['notiset_bunyangsuyo_mylive'] == 1 ? true : false} onChange={notiset_bunyangsuyo_mylive_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
      ...
      <div className="par-spacing mb-1">
        ...
        <FormControlLabel
          label="내 방문예약"
          control={<Checkbox checked={alramsetting['notiset_bunyangsuyo_myvisit'] == 1 ? true : false} onChange={notiset_bunyangsuyo_myvisit_change} />}
        />
        <p className="par-indent-left-2x capt-a1">
