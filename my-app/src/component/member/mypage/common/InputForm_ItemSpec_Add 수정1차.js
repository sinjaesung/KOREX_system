...
export default function InputForm_ItemSpec_Add({ updateModal, serveruploadimgs_server, changeaddedimgs_server, mode, setimgfiles, imgfiles }) {
          ...
          <div className="par-spacing">
            <FormControl fullWidth>
              ...
              <div className="flex-center-center">
                ...
                :
                  <h4>등록된 사진 수 : {serveruploadimgs_server.length}</h4>
                }
                  {/* {
