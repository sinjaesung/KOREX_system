...
export default function ReportModal({report,setReport,off,setOff}) {
  ...
  const pageLoader = () =>{
    switch (pageIndex) {
      ...
      case 3: return <ReportModalComplete updatePageIndex={updatePageIndex} report={report} setReport={setReport} off={off} setOff={setOff}/>
