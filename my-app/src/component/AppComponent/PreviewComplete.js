  ...
  const [slideUp6, setSlideUp6] = useState(false);
        ...
        <WrapDetail>
            ...
            <TopMainInfoBox>
                ...
                <Number>등록번호 1234567889  {maemulinfo.prd_identity_id}</Number>
                ...
                <ItemInfo>
                  <Name>
                      ...
                      <Address>{maemulinfo.prd_name}{maemulinfo.addr_detail}</Address>
                  </Name>
        ...
        <WrapAllInfos>
            ...
            <WrapItemInfo>
                ...
                <ItemInfoList>
                    ...
                    <SubDesc>{maemulinfo.addr_detail}/{buildinginfo.grd_floor}</SubDesc>
                    </Li>
                    <Li>
                ...
                </TitleBox>
                {
                    ...
                    <ItemInfoList>
                        ...
                        <Li>
                            ...
                            <SubDesc>{maemulinfo.month_base_guaranteeprice}</SubDesc>
                        </Li>
                    </ItemInfoList>
                    :
                    null
