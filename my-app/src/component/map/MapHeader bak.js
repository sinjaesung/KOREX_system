...
//code
import MobileSearchMain from "../main/MobileSearchMain";
        ...
        <div>
          <HederLogo>
          {
            ...
            <HeaderSearch>
              ...
              <TextField
                onClick={() => { setSearchShow(true); setRecentlysearch_show(1);}}
                ref={mapheader_search_element}
          ...
          <HederLogo>
            ...
            <HeaderSearch>
...

              {
                isPc ?
                  <TextField
                    onClick={() => { setSearchShow(true); setRecentlysearch_show(1);console.log("동작1"); }}
                    ref={mapheader_search_element}
                    onChange={search_map_main}
                    placeholder='지하철,대학교,지역명 등 입력'
                    onKeyPress={keypress_handle}
                  ...
                  :
                  // <TextField
                  //   onClick={() => { history.push(`/Mbsearch`);console.log("동작"); }}
                  //   // ref={mapheader_search_element}
                  //   // onChange={search_map_main}
                  //   placeholder='지하철,대학교,지역명 등 입력'
                  //   // onKeyPress={keypress_handle}
                  ...
                  //     endAdornment: (
                  //       <InputAdornment position="end">
                  //         <SearchBtn type="submit" name="" onClick={() => { history.push(`/Mbsearch`); }} />
                  //       </InputAdornment>
                  //     ),
                  //   }}
                  //   variant="outlined"
                  // />
                  <MobileSearchMain activeText={`store`}/>
              }

              {/* <TextField
                onClick={() => { setSearchShow(true); setRecentlysearch_show(1); console.log("동작 2"); }} 
                ref={mapheader_search_element} 
                onChange={search_map_main} 
                placeholder='지하철,대학교,지역명 등 입력' 
                onKeyPress={keypress_handle}
                ...
                variant="outlined"
              /> */}
              {/* {console.log('mapheader_search_element이거다  ', mapheader_search_element.current)} */}
