...
export default function KakaoMap({ status, mapheader_search_element }) {
  ...
  */
  ...
  useEffect(() => {
    ...
    console.log('mapData확인', JSON.parse(localStorage.getItem("mapData")));
 ...
 /* useEffect(() => {
  ...
  useEffect(() => {
      let searchdetail_origindata = JSON.parse(localStorage.getItem("searchdetail_origin"));
      let mapData = JSON.parse(localStorage.getItem("mapData"));
    console.log('초기 맵 정보', JSON.parse(localStorage.getItem("mapData")));

    console.log('여기를 확인654', searchdetail_origindata);
    console.log('여기를 확인654', mapData);
