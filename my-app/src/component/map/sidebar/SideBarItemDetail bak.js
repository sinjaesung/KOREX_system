        ...
        <Sect_Article_1>
          ...
          <div className="pd-0p75" >
              ...
              <div className="flex-spabetween-center">
                ...
                <Tooltip title="허위매물 신고">
                  <MUIconButton size="middle">
                    <ReportGmailerrorredIcon color="error" onClick={() => {setReport([true,click_prdidentityid,broker.company_id])}}/>
                  </MUIconButton>
                </Tooltip>
                <LikeCheckBtn user={loginUser} item={product} />
                {/* <div>
            ...
            <div className="par-spacing-after">
              ...
              <p className="txt-sub">[{deteilproducts.prd_type}] &nbsp;{deteilproducts.addr_jibun}</p>
              <div className="flex-right-baseline">
                ...
                <span className="detail-subtit fw-b">{deteilproducts.prd_sel_type}&nbsp;</span>
                <span className="detail-tit fw-b">{deteilproducts.prd_price} </span>
              </div>
            </div>
            <div className="par-spacing-after tAlign-r">
                <MUButton variant="outlined" disableElevation startIcon={<ShowChartIcon />} onClick={(event)=>{
