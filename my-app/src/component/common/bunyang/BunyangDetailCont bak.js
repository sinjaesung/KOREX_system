...
export default function BunyangDetailCont({ bunyangDetail, onClickList, setLive, setDetailImg, setCal, livetour, optionList, numberWithCommas, contact,invitetour, active, LikeBtnEvent, readOnly, setReadOnly }) {

  // console.log('여기확인하기  ', livetour );
  console.log('여기확인하기 ', bunyangDetail );
  // console.log('여기확인하기 ', bunyangDetail.liveChecked );
  // console.log('여기확인하기 ', bunyangDetail.liveChecked );
        ...
        <Sect_C2>
            ...
            bunyangDetail.liveDate ?
              <div className="par-spacing-after">
                <EmBox>
                  ...
                  <h3>LIVE 방송일시 : {bunyangDetail.liveDate}</h3>
          ...
          <Box_1 className="par-spacing">
            <UtilBtns>
              ...
              <Tooltip title="좋아요" disabled={ readOnly}>
                <MUCheckbox disabled={readOnly} icon={<FavoriteBorder />} checkedIcon={<Favorite color="secondary"/>} checked={active} onClick={LikeBtnEvent}/>
              </Tooltip>
              {/* <LikeBtn>
                <Like type="checkbox" id="like" checked={bunyangDetail.isLike} onClick={LikeBtnEvent}></Like>
