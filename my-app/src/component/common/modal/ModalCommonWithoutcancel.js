...
export default function ModalCommonWithoutcancel({modalOption,value}) {
        ...
        >
          ...
          <DialogActions>
            {
              modalOption.cancle && modalOption.cancle.show ?
                <MUButton type="button" name="" onClick={() => { modalOption.cancle.event(value) }}>
                  <Link to={modalOption.cancle.link} className="data_link" />
                  {modalOption.cancle.title}
                </MUButton>
                :
                null
            }
          ...
          {/* <WrapFilterModal>
            ...
            <ModalFilter>
              ...
              {
                modalOption.cancle && modalOption.cancle.show ?
                <ResetBtn type="button" name="" onClick={()=>{modalOption.cancle.event(value)}}>{modalOption.cancle.title}</ResetBtn>
                :
                null
              }
              {
                ...
                <Link to={modalOption.submit.link}>
                  <SaveBtn type="button" name="" onClick={()=>{modalOption.submit.event(value)}}>{modalOption.submit.title}</SaveBtn>
                </Link>
                :
                null
              }
              {
                modalOption.submitnone && modalOption.submitnone.show ?
                  <SaveBtn type="button" name="" onClick={()=>{modalOption.submitnone.event(value)}}>{modalOption.submitnone.title}</SaveBtn>
                :
                null
              }
              {
